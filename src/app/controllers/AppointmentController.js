...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    axios.get(
      `https://api.dr.help/message?number=5583988736747&message=Este é um lembrete, você acabou de agendar ${filter} para às ${hourStart.getHours()}:${hourStart.getMinutes()} no dia ${hourStart.getDate()}/${hourStart.getMonth()}h&token=${process.env.ZAP_TOKEN}`
    );
